...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.Logo, 0, QtCore.Qt.AlignLeft)
...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.AccountWidget, 0, QtCore.Qt.AlignRight|QtCore.Qt.AlignTop)
